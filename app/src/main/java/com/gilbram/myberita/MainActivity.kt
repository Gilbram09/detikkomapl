...
import com.gilbram.myberita.Adapter.NewsAdapter
import com.gilbram.myberita.Adapter.NewsModel
import com.gilbram.myberita.Adapter.news
            ...
            override fun onItemClick(data: news) {
                val intent= Intent(this@MainActivity,DetailActivity::class.java)
                    .apply {
                        ...
                        putExtra(DetailActivity.cont_isinews,data.isi.toString())
                    }
